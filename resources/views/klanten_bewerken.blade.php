        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('klanten.bewerken.post', $index) }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        @if($isDummy)
                            <div class="mt-4 text-xs text-gray-500">Let op: wijzigingen aan dummy-klanten zijn tijdelijk en worden niet opgeslagen in een database.</div>
                        @endif
                    </form>
                </div>
            </div>
